...
public:
    ...
    void addServer              (const SleepyDiscord::Server& acrServer, const std::vector<SleepyDiscord::User>& acrBannedUsers);  // acrBannedUserIDs passed to function since getBans() is a member function of client
